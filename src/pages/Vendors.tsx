...
const rows = [
  {
    id: 1,
    vendorName: "Oastag Devs",
    longitude: 1.7,
    latitude: 10.211,
    product: "Computer Electronics: ",
    email: "oastagdevs@gmail.com",
    phoneNumber: "0247506391",
    location: "Sunyani",
    icon: "https://uilogos.co/img/logotype/treva.png",
  },
  {
    id: 2,
    vendorName: "Something Else",
    longitude: 1.7,
    latitude: 10.211,
    product: "Computer Electronics: ",
    email: "oastagdevs@gmail.com",
    phoneNumber: "0247506391",
    location: "Sunyani",
    icon: "https://uilogos.co/img/logotype/circle.png",
  },
];
    ...
    { field: "id", headerName: "id", width: 130 },
    {
      ...
      renderCell: (params: GridCellParams) => (
        <div className={classes.flex}>
          ...
          <Typography
            variant="body1"
            style={{ color: "#333", fontSize: 14, marginLeft: 5 }}
          >
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.actionsContainer}>
        <Paper
          elevation={0}
          className={clsx(classes.searchContainer, classes.boxShadow)}
        >
          <input
            type="text"
            placeholder="Search"
        ...
        <Paper
          elevation={0}
          className={clsx(classes.filterBusinessType, classes.boxShadow)}
        >
          <Select
            options={optionLocations}
            placeholder="Filter Location"
            className={classes.filterBusinessSelect}
          />
        </Paper>
        <Paper
          elevation={0}
